...
<div class="container my-5">
    <div class="d-flex justify-content-between aling-items-center">
        ...
        <div>
            ...
            <a class="btn btn-success" href="{{route('admin.technologies.create')}}">ADD Technology</a>            
        </div>
    </div>
</div>
<div class="container">
    <table class="table table-success table-striped">
        ...
        <tbody>
            @foreach ($technologies as $technology)
                <tr class="d-flex justify-content-between">
                    <td scope="row" class="flex-grow-1">{{$technology->name}}</td>
                    @auth
                        <td>
                            <a class="link-secondary px-3" href="{{ route('admin.technologies.edit', $technology) }}">Update</a>              
